...
parser.add_argument('--dataset', type=str, default='light', metavar='str',
...
parser.add_argument('--net_G', type=str, default='fpn_inception', metavar='str',
                    help='net_G: unet_512, unet_256 or unet_128 or unet_64 or '
                    'fpn_mobilenet or fpn_inception (default: unet_128)')
parser.add_argument('--ngf', type=int, default=64, metavar='N',
                    help='number of base filters in G')
parser.add_argument('--batch_size', type=int, default=4, metavar='N',
                    help='input batch size for training (default: 4)')
parser.add_argument('--pixel_loss', type=str, default='pixel_loss', metavar='str',
...
parser.add_argument('--metric', type=str, default='psnr_gt1',
                    help='metric to update ckpt, from [psnr, ssim, psnr_gt1, ssim_gt1, labrmse_gt1] (default: psnr)')
parser.add_argument('--is_attention', type=int, default=1,
                    help='is_attention: if 1, add attention block, default 0 not add')
parser.add_argument('--attention_num', type=int, default=0,
                    help='attention_num: 0 se_block, 1 cbam_block, 2 eca_block')
parser.add_argument('--attention_location', type=int, default=1,
                    help='0 before 1x1 conv Lateral connections, 1 behind 1x1 conv Lateral connections')
...
if __name__ == '__main__':
    ...
    grgan = gr.GRGAN(args=args, dataloaders=dataloaders)
    grgan.train_models()
